...
_These issues cause runtime errors or broken user flows. Fix first._
...
_These are real bugs that affect correctness but don't crash the app._
...
_These improve perceived and actual performance._
...
_These improve the user experience but are not blockers._
...
_These improve accessibility and maintainability._
...
_Larger architectural improvements._
